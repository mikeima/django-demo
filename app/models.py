...
class OzmWithForeignKey(models.Model):
    class Meta:
        verbose_name = 'ОЗМ'
        verbose_name_plural = 'ОЗМ'
    ...
    ozm = models.CharField(max_length=25,
                           verbose_name='ОЗМ',
                           null=True)
    k_b = models.ForeignKey(to=K_B,
                            verbose_name='Код К/Б',
                            on_delete=models.SET_NULL,
                            null=True)
    grammage = models.ForeignKey(to=Grammage,
                                 verbose_name='Код Граммаж',
                                 on_delete=models.SET_NULL,
                                 null=True)
    producer = models.ForeignKey(to=Producer,
                                 verbose_name='Код Поставщик',
                                 on_delete=models.SET_NULL,
                                 null=True)
    material_type = models.ForeignKey(to=Material,
                                      verbose_name='Код Тип сырья',
                                      on_delete=models.SET_NULL,
                                      null=True)
...
class T13_050WithForeignKey(models.Model):
    class Meta:
        verbose_name = '13/050'
        verbose_name_plural = '13/050'
    ...
    f13_050 = models.CharField(max_length=25,
                               verbose_name='13/050',
                               null=True)
    income_datetime = models.ForeignKey(to=IncomeDateTime,
                                        verbose_name='Код Дата поступления',
                                        on_delete=models.SET_NULL,
                                        null=True)
    pole1 = models.IntegerField(verbose_name='Поле 1',
                                null=True)
...
class InvoiceWithForeignKey(models.Model):
    class Meta:
        verbose_name = 'Накладная'
        verbose_name_plural = 'Накладные'
    ...
    code = models.CharField(max_length=255,
                            verbose_name='Код Накладная',
                            unique=True)
    code13_050 = models.ForeignKey(to=T13_050WithForeignKey,
                                   verbose_name='Код 13/050',
                                   on_delete=models.SET_NULL,
                                   null=True)
    pole1 = models.CharField(max_length=255,
                             verbose_name='Поле1',
...
class RollWithForeignKey(models.Model):
    class Meta:
        verbose_name = 'Рулон'
        verbose_name_plural = 'Рулоны'
    ...
    grammage = models.ForeignKey(to=Grammage,
                                 ...
                                 on_delete=models.SET_NULL,
                                 null=True)
    roll_format = models.ForeignKey(to=Format,
                                    verbose_name='Код Формат',
                                    on_delete=models.SET_NULL,
                                    null=True)
    producer = models.ForeignKey(to=Producer,
    ...
    vehicle = models.CharField(max_length=255,
                               verbose_name='Тр_средство',
                               null=True)
    invoice = models.ForeignKey(to=InvoiceWithForeignKey,
                                verbose_name='Код Накладная',
                                on_delete=models.SET_NULL,
                                null=True)
    input_datetime = models.DateTimeField(verbose_name='Дата/время ввода',
...
class ConsumptionWithForeignKey(models.Model):
    class Meta:
        verbose_name = 'Расход'
        verbose_name_plural = 'Расход'
    ...
    code = models.IntegerField(verbose_name='Код Расход',
                               unique=True)
    roll_number = models.ForeignKey(to=RollWithForeignKey,
                                    verbose_name='Код № Рулона',
                                    on_delete=models.SET_NULL,
                                    null=True)
    code_datetime = models.ForeignKey(to=ConsumptionDateTime,
                                      verbose_name='Код Дата расхода',
                                      on_delete=models.SET_NULL,
                                      null=True)
    pole1 = models.IntegerField(verbose_name='Поле1',
                                null=True)
